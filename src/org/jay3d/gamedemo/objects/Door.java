package org.jay3d.gamedemo.objects;
...
public class Door {
    ...
    public static final double TIME_TO_OPEN = 1.0; //TODO: Make values appropiate
    ...
    public Door(Transform transform, Material material, Vector3f openPosition) {
        ...
        if(mesh == null){
            Vertex[] vertices = new Vertex[]{
                    ...
                    new Vertex(new Vector3f(LENGTH, START, START), new Vector2f(0.75f, 1f)),

                    new Vertex(new Vector3f(START, START, START), new Vector2f(0.73f, 1)),
                    new Vertex(new Vector3f(START, HEIGHT, START), new Vector2f(0.75f, 0.75f)),
